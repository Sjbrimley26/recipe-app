...
- remove duplicate items from the backend 
  - items like 'white sugar' and 'granulated white ssugar' can be merged in the backend for ease of use on both the database and client side. I currently have quite a list that are taken care of but I find more every time I run the crawler
